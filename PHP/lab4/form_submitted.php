...
if($_SERVER["REQUEST_METHOD"]=="POST")
   ...
   */
   ...
   {
	 $hasError=true;   
	$err_about="*Select  1 or many options"; 
   }
   else
   {
	 $gender=$_POST["about"];   
...
<table>
                ...
                <tr>
                    ...
                    <td>:<input type="checkbox" value="A friend or colleague" name="about[]">A friend or colleague 
                   
                </tr>

                <tr>
                <td>:<input type="checkbox" value="Google" name="about[]">Google</td>
                    
                    
                    
                </tr>
                <tr>
                <td>:<input type="checkbox" value="Blog Post" name="about[]">Blog Post</td>
                    
                
                </tr>

                <tr>
                    <td>:<input type="checkbox" value="News Article" name="about[]">News Article 
              <span style="color:red"><?php echo $err_about; ?></span>
                    </td>
                </tr>
